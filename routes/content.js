...
router.get("/contactus", function(req, res, next){
    res.json(handler.contactUsContents());
...
router.get("/gooddetail", function(req, res, next){
    res.json(handler.goodDetailContents());
...
router.post(
    ...
    async function(req, res, next) {
        let newContent = {};
        if (req.body.content && req.body.content.contentType) {
            if (req.body.content.contentType == "index") {
                newContent = await handler.editIndexContent(req.body.content.content);
            }
            if (req.body.content.contentType == "template") {
                newContent = await handler.editTemplateContent(req.body.content.content);
            }
            if (req.body.content.contentType == "cart") {
                newContent = await handler.editCartContent(req.body.content.content);
            }
            if (req.body.content.contentType == "contactus") {
                newContent = await handler.editContactUsContent(req.body.content.content);
            }
        }
        res.json(newContent);
